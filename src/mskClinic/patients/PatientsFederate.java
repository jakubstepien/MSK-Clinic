 ...
 */
public class PatientsFederate {
    public static final String FederationName = "ClinicFederation";
    public static final String federateName = "Patients";
    ...
    public void runFederate() throws Exception {
        ...
        // connect
        log("Connecting...");
        fedamb = new PatientsAmbassador(this);
    ...
    private void sendPatientEnteredClinic(double currentTime) throws RTIexception {
        ...
        ParameterHandle openTime = rtiamb.getParameterHandle(patientEnteredHandle, "PatientId");

        parameters.put(openTime, encoderFactory.createHLAinteger32BE(currentId).toByteArray());
    ...
    public static void main(String[] args) {
        try {
            new PatientsFederate().runFederate();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
